...
my @csproj_files = (
	...
	{ csproj => 'framework/Knot3.Framework-MonoGame.csproj', dir => 'src/', exclude => ['-XNA.cs'], linesep => qq[\n] },
	{ csproj => 'framework/Knot3.Framework-XNA.csproj', dir => 'src/', exclude => ['-MonoGame.cs'], linesep => qq[\n] },
